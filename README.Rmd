...
[![CRAN status](https://www.r-pkg.org/badges/version/shiny.dsfr)](https://CRAN.R-project.org/package=shiny.dsfr)
<!-- badges: end -->

`shiny.dsfr` est un package servant poc de démonstration pour faciliter l'intégration de la charte graphique de l'Etat dans les applications shiny. 
